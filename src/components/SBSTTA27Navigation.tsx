    ...
    <div className="pt-8">
      ...
      {isMenuOpen && (
        <>
          ...
          {/* Mobile Menu */}
          <nav className="xl:hidden mt-4 bg-white rounded-2xl border border-gray-200 shadow-2xl overflow-hidden mobile-menu relative z-50 max-h-[80vh] overflow-y-auto">
