...
import { Calendar, Users, ArrowRight, MapPin, Globe } from 'lucide-react';
...
const MeetingsSection = () => {
  return (
    <section id="meetings" className="py-16 lg:py-20 relative bg-white">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
          ...
          <Card className="overflow-hidden bg-gradient-to-br from-card to-card/80 relative flex flex-col border-2" style={{ borderColor: 'hsl(var(--iifb-orange))' }}>
            ...
            <CardHeader className="pb-4">
              <div className="flex items-center justify-between mb-3">
                <CardTitle className="text-2xl lg:text-3xl text-foreground">SBSTTA</CardTitle>
              ...
              <CardDescription className="text-base text-muted-foreground mb-4">
                The 27th meeting of the Subsidiary Body on Scientific, Technical and Technological Advice (SBSTTA-27) under the Convention on Biological Diversity (CBD)
              </CardDescription>
              <div className="flex items-center gap-2 text-xl lg:text-2xl font-bold text-foreground mb-4">
          ...
          <Card className="overflow-hidden bg-gradient-to-br from-card to-card/80 relative flex flex-col border-2" style={{ borderColor: 'hsl(var(--iifb-orange))' }}>
            ...
            <CardHeader className="pb-4">
              ...
              <CardDescription className="text-base text-muted-foreground mb-4">
                The First Meeting of the Subsidiary Body on Article 8(j) and Related Provisions (SB8J-1)
              </CardDescription>
              <div className="flex items-center gap-2 text-xl lg:text-2xl font-bold text-foreground mb-4">
