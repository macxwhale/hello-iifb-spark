...
const IntroductionSection = () => {
  ...
  return (
    <>
      ...
      <section className="w-full py-12 lg:py-16 text-center relative" lang="en" translate="yes">
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-24 h-1 rounded-full" style={{ backgroundColor: 'hsl(var(--iifb-orange))' }} aria-hidden="true"></div>
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center gap-3 mb-6">
            <div className="w-3 h-3 rounded-full animate-pulse" style={{ backgroundColor: 'hsl(var(--iifb-orange))' }} aria-hidden="true"></div>
            <span className="text-sm font-semibold uppercase tracking-widest" style={{ color: 'hsl(var(--iifb-orange))' }} translate="yes">About the Meetings</span>
            <div className="w-3 h-3 rounded-full animate-pulse" style={{ backgroundColor: 'hsl(var(--iifb-orange))' }} aria-hidden="true"></div>
          </div>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4" translate="yes">
            WELCOME TO
            <span className="block mt-2 relative" style={{ color: 'hsl(var(--iifb-orange))' }} translate="yes">
              SBSTTA-27 AND SB8J-1, PANAMA 2025
              <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-32 h-1 bg-gradient-to-r from-transparent to-transparent" style={{ background: `linear-gradient(to right, transparent, hsl(var(--iifb-orange)), transparent)` }} aria-hidden="true"></div>
            </span>
          </h2>
           <div className="space-y-8 max-w-7xl mx-auto">
             {/* Main Content - Single Column Layout */}
              <div className="bg-gradient-to-r from-primary/5 to-accent/5 border border-primary/20 rounded-xl p-8" translate="yes">
                <div className="text-left mb-6">
                  <div className="inline-flex items-center gap-2 bg-primary/10 rounded-full px-4 py-2 mb-4">
                    <Triangle className="h-4 w-4 text-primary" aria-hidden="true" />
                    <span className="text-sm font-semibold text-primary uppercase tracking-wide" translate="yes">IIFB Welcome</span>
                  </div>
                </div>
                <div className="space-y-6 text-lg text-foreground leading-relaxed text-left" translate="yes">
                 <p translate="yes">
                 ...
                 <p className="ml-6 text-lg" translate="yes">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 lg:mt-16 flex justify-center px-4">
            <div className="w-full max-w-4xl">
              <blockquote className="text-center" translate="yes">
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-0" translate="yes">
                  <span className="block mt-2 relative text-center" style={{ color: 'hsl(var(--iifb-orange))' }} translate="yes">
