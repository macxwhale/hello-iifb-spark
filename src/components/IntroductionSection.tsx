  ...
  return (
    <>
      ...
      <section className="w-full py-12 lg:py-16 text-center relative">
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-24 h-1 rounded-full bg-primary"></div>
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center gap-3 mb-6">
            <div className="w-3 h-3 rounded-full animate-pulse bg-primary"></div>
            <span className="text-sm font-semibold uppercase tracking-widest text-primary">About the Meetings</span>
            <div className="w-3 h-3 rounded-full animate-pulse bg-primary"></div>
          </div>
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-4">
            WELCOME TO
            <span className="block mt-2 relative text-primary">
